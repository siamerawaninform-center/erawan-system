...
const PRINT_CSS = `
  ...
  *{ box-sizing:border-box; }
  ...
  .sheet{ background:#fff; width:210mm; min-height:297mm; margin:0 auto 16px; padding:6mm 9mm 5mm; box-shadow:0 4px 24px rgba(0,0,0,.3); position:relative; color:#171717; font-size:18px; font-weight:600; }
  ...
  .dc-name{ font-family:'Chakra Petch',sans-serif; font-weight:700; font-size:18px; margin-bottom:2px; color:var(--ink); }
  ...
  .doc-name{ background:var(--ink); color:#fff; padding:5px 26px; letter-spacing:.03em; font-family:'Chakra Petch',sans-serif; font-weight:700; font-size:18px; border-radius:2px; display:inline-block; }

  .jsa-meta{ display:grid; grid-template-columns:1fr 1fr; gap:4px 20px; font-size:18px; margin-bottom:4px; }
