...
const PRINT_CSS = `
  ...
  *{ box-sizing:border-box; }
  ...
  .plan-header{ display:flex; justify-content:space-between; font-size:8px; margin-bottom:10px; line-height:1.6; }
  ...
  .plan-sig{ display:flex; flex-direction:column; align-items:center; gap:3px; width:180px; font-size:8px; }
